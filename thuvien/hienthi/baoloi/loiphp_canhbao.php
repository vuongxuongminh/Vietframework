...
/*
 * CHỨC NĂNG TỆP:
 * Tệp báo lỗi khi xảy ra lỗi php cảnh báo (warning)
 */
?>
<div style="font-family: tahoma, arial; font-size:14px; width:96%; margin:1%; background-color: #c60000; border-radius: 5px; padding: 1%; color: #fff; word-wrap: break-word; box-shadow: 0px 0px 7px rgba(0,0,0,0.5);">
    <span><?php echo $this->doiTuongHtml->napHinhAnh("vietFrameWork/error-img-02.png", array("style" => "margin-right:10px; vertical-align: middle")); ?>Cảnh báo (WARNING): <?php echo $mangLoiPHP[1]; ?> - Tệp: <?php echo $mangLoiPHP[2]; ?> - Dòng: <?php echo $mangLoiPHP[3]; ?></span>
</div>